...
namespace Contracts.Api.Application.Commands.PreContractCommands
{
    ...
    public class CreatePreContractMasisveCommandHandler : IRequestHandler<CreatePreContractMasisveCommand, MessageResponse>
    {
        ...
        //        //var customersFound = await this._iServiceCustomerLambda.SearchCustomer<Customers>(1);
        //        //var idSummaFound = await this._iServiceCustomer.SearchIdSumma();
        //        //var customerSummaFound = await this._iServiceCustomer.SearchCustomerSumma(string.Empty);
        ...
        //private async Task<List<CreatePreContractLogDetailCommand>> RegisterTemplateVTex(ExcelWorksheet excelWorksheet, int startRow, int endRow, IEnumerable<IdSummaBE> idSummaList, IEnumerable<CustomerSummaBE> customerSummaList, IEnumerable<CategoryViewModel> categorylist, IEnumerable<TradenameViewModel> tradenameList)
        //{
        ...
        //            var idSummaFound = idSummaList.Where(x => x.tradename == excelWorksheet.Cells[startRow, 2].Value.ToString().Trim());
        //            var tradenameFound = tradenameList.Where(t => t.TradenameName == excelWorksheet.Cells[startRow, 2].Value.ToString().Trim());
        //            if (!idSummaFound.Any() || !tradenameFound.Any())
        //                messageValidation = "El Id Summa no esta registrado,";
        //            else
        //            {
        //                var customerSummaFound = customerSummaList.Where(x => x.id_summa == idSummaFound.FirstOrDefault().id_summa && x.document_id == excelWorksheet.Cells[startRow, 1].Value.ToString());
        //                if (!customerSummaFound.Any())
        //                    messageValidation = "El R.U.C, no esta asociado al Id Summa";
        //            }
        //        }
        ...
        //private async Task<List<CreatePreContractLogDetailCommand>> RegisterTemplateSellerCenter(ExcelWorksheet excelWorksheet, int startRow, int endRow, IEnumerable<IdSummaBE> idSummaList, IEnumerable<CustomerSummaBE> customerSummaList, IEnumerable<Customers> customerList, IEnumerable<TradenameMSAdvance> tradenameList, IEnumerable<CategoryViewModel> categorylist)
        //{
        ...
        //            var tradenameFound = tradenameList.Where(t => t.TradenameName == excelWorksheet.Cells[startRow, 2].Value.ToString().Trim());
        //            if (!idSummaFound.Any() || !tradenameFound.Any())
        //                messageValidationIdSumma = "El Id Summa no esta registrado,";
        //            else
        //            {
        //                var customerSummaFound = customerSummaList.Where(x => x.id_summa == idSummaFound.FirstOrDefault().id_summa && x.document_id == excelWorksheet.Cells[startRow, 1].Value.ToString());
        //                if (!customerSummaFound.Any())
        //                    messageValidationIdSumma = "El R.U.C, no esta asociado al Id Summa";
        //            }
        //        }
        ...
        //private async Task<List<CreatePreContractLogDetailCommand>> RegisterTemplateVtexToVtex(ExcelWorksheet excelWorksheet, int startRow, int endRow, IEnumerable<IdSummaBE> idSummaList, IEnumerable<CustomerSummaBE> customerSummaList, IEnumerable<Customers> customerList, IEnumerable<TradenameMSAdvance> tradenameList, IEnumerable<CategoryViewModel> categorylist)
        //{
        //    List<CreatePreContractLogDetailCommand> preContractLogDetailsList = new List<CreatePreContractLogDetailCommand>();
        //    CreatePreContractLogDetailCommand preContractLogDetails = null;
        //    var rucAnulled = new List<string>();
        ...
        //    }
        //}
        public Task<MessageResponse> Handle(CreatePreContractMasisveCommand request, CancellationToken cancellationToken)
        {
