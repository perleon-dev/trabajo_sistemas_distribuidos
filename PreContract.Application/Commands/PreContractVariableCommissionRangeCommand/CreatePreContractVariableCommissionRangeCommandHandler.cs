...
namespace Contracts.Api.Application.Commands.PreContractVariableCommissionRangeCommand
{
	public class CreatePreContractVariableCommissionRangeCommandHandler : IRequestHandler<CreatePreContractVariableCommissionRangeCommand, int>
	{
		...
		public CreatePreContractVariableCommissionRangeCommandHandler(IPreContractVariableCommissionRangeRepository iPreContractVariableCommissionRangeRepository, IValuesSettings iValuesSettings)
		{
			_iPreContractVariableCommissionRangeRepository = iPreContractVariableCommissionRangeRepository;
			_iValuesSettings = iValuesSettings;
		}

		public async Task<int> Handle(CreatePreContractVariableCommissionRangeCommand request, CancellationToken cancellationToken)
		{
			PreContractVariableCommissionRange preContractVariableCommissionRange = new PreContractVariableCommissionRange(request.contract_id, request.contract_version, request.contract_modification, request.contract_tradename_id, request.state, request.validity_time, request.validity_active, request.percentage, request.validity_start_date, request.validity_end_date, request.grade, request.register_user_id, request.register_user_fullname, DateTime.Now.Peru(_iValuesSettings.GetTimeZone()), request.update_user_id, request.update_user_fullname, DateTime.Now.Peru(_iValuesSettings.GetTimeZone()), request.category_id);
