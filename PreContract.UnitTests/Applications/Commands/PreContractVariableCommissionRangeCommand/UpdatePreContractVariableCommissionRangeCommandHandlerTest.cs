...
namespace Contracts.Api.UnitTests.Application.Commands.PreContractVariableCommissionRangeCommand
{
    ...
    {
        private readonly UpdatePreContractVariableCommissionRangeCommandHandler _sut;
        ...
        public UpdatePreContractVariableCommissionRangeCommandHandlerTest()
        {
            ...
            this._sut = new UpdatePreContractVariableCommissionRangeCommandHandler(this._IPreContractVariableCommissionRangeRepository.Object, this._IValuesSettings.Object);
        }

        [Fact]
        public async Task Handle() 
        {
            UpdatePreContractVariableCommissionRangeCommand command = new UpdatePreContractVariableCommissionRangeCommand();
